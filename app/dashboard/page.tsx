...
import ChronotypPlanerPage from '@/components/checks/ChronotypPlanerPage';
    ...
    <main className={sidebarOpen ? 'sidebar-open' : ''}>
      ...
      <div className="main-content">
        ...
        <div className="content-wrapper">
          ...
          {activeMenuItem === 'chronotyp-planer' && (
            <ChronotypPlanerPage onBack={() => setActiveMenuItem('quick-wins')} />
          )}
