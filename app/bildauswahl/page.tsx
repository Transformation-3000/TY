      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '1.8rem' }}>
            ...
            <div style={{ background: 'rgba(30, 41, 59, 0.8)', border: '1px solid rgba(56, 189, 248, 0.4)', borderRadius: '16px', overflow: 'hidden' }}>
              <div style={{ position: 'relative', width: '100%' }}>
                <img src="/images/slider3_clean_meditation.jpg" alt="Slider 3 Live" style={{ width: '100%', height: '220px', objectFit: 'cover', display: 'block' }} />
              ...
              <div style={{ padding: '1.2rem' }}>
                ...
                <code style={{ fontSize: '0.78rem', color: '#38bdf8', background: 'rgba(0,0,0,0.4)', padding: '0.3rem 0.6rem', borderRadius: '6px', display: 'inline-block' }}>/images/slider3_clean_meditation.jpg</code>
              </div>
            </div>
          </div>
        </div>
