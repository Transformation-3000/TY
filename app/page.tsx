...
const heroSlides = [
  ...
  { 
    ...
    bullets: [
      { text: 'Nutze wissenschaftliche Erkenntnisse, um deine Vitalität und dein biologisches Alter gezielt zu beeinflussen', icon: '/images/slider2_icon1_sparkles.svg' },
