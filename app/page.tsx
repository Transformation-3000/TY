...
const heroSlides = [
  { 
    ...
    bullets: [
      { text: 'Stärke die Faktoren, die dich dauerhaft leistungsfähig halten', icon: '/images/icon_schlaf_3d.png' },
      { text: 'Reduziere die Auswirkungen anhaltend hoher Belastung', icon: '/images/icon_immun_3d.png' },
      { text: 'Erlebe Fortschritte bei Energie, Konzentration & Resilienz', icon: '/images/icon_zell_3d.png' }
    ]
  },
  { 
    id: 2, 
