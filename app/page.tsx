        ...
        <div className="final-cta-card">
          <div className="final-cta-grid">
            <div className="final-cta-text-col">
              ...
              <p>
                Während der normale Lebensweg meist zu einem stetigen, unkontrollierten Verlust an zellulärer Vitalität führt, ermöglicht dir unser Ansatz eine signifikante Verjüngung. So sicherst du dir viele zusätzliche vitale & kraftvolle Lebensjahre mit mehr Lebensfreude.
              </p>
